...
public class SimSimiServiceBuilder {
    ...
    private static List<Interceptor> defaultInterceptors() {
        ...
        return Arrays.asList(
                new HeaderInterceptor(),            // 固定需要的 header, user-agent, etc.
                new DefaultQueryInterceptor(),      // 固定需要的 query, like key, secret, authorization, etc.
     ...
     * <p>
     * <p>ref: {@link SimSimiServiceBuilder#createDefaultRetrofitBuilder()} ()}.</p>
     */
